...
namespace ICSharpCode.ILSpy
{
    ...
    public class TypeScriptLanguage : Language
    {
...
#if DEBUG
        internal static IEnumerable<TypeScriptLanguage> GetDebugLanguages()
        {
            ...
            foreach (Type _transformType in TransformationPipeline.CreatePipeline(context).Select(v => v.GetType()).Distinct())
            {
                ...
                yield return new TypeScriptLanguage()
                {
        ...
        public override void DecompileAssembly(LoadedAssembly assembly, ITextOutput output, DecompilationOptions options)
        {
            ...
            else
            {
                ...
                using (options.FullDecompilation ? null : LoadedAssembly.DisableAssemblyLoad())
                {
                    ...
                    new CsToTs().Run(codeDomBuilder.SyntaxTree);
        ...
        string TypeToString(ConvertTypeOptions options, TypeReference type, ICustomAttributeProvider typeAttributes = null)
        {
            ...
            astType.AcceptVisitor(new Netjs.TsOutputVisitor(w, FormattingOptionsFactory.CreateAllman()));
            return w.ToString();
        }
